...
if section == "Methodological Profile":
    st.markdown("### Perfil Metodológico")
    col1, col2 = st.columns(2)
    with col1: # 1. Research Approaches
        st.markdown("##### Research approaches")
        st.markdown("Texto sobre o subtópico em discussão.")
    ...
    col1, col2 = st.columns(2)
    with col1:  # 2. Research Methods
        st.markdown("##### Research Methods")
        st.markdown("Texto sobre o sub-tópico em discussão.")
...
if section == "Thematic Profile":
    ...
    with col1:  # 2. Research Topic
        st.markdown("##### Topico de pesquisa")
        st.markdown("Texto sobre o sub-tópico em discussão.")
    ...
    with col1: # 3. Research Context
        st.markdown("##### O Contexto da pesquisa")
        st.markdown("Texto sobre o subtópico em discussão.")
    ...
    with col1:  # 4. Geographical Context
        st.markdown("##### O Contexto geográfico")
        st.markdown("Texto sobre o sub-tópico em discussão.")
...
if section == "Technologies discussed":
    st.markdown("### Technologies discussed")
    col1, col2 = st.columns(2)        
    with col1:   # Technology Discussed
        st.markdown("##### Tecnologias discutidas")
